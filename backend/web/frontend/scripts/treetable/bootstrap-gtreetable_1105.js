...
(function ($) {
    ...
    function GTreeTable(element, options) {
        ...
        '</td>' +
        '<td>' +
        '<div class="show"><input type="radio" name="aa" value="是"/>' +
        '<input type="radio" name="bb" value="否"/></div>' +
        ...
        '</td>' +
        '<td>' +
        '<a class="node-action-1" tabindex="-1" href="#notarget">编辑</a>'+


        '<a href="#notarget" class="node-action-0' + '" tabindex="-1">创建下级</a>'+
        '<a class="node-action-2" tabindex="-1" href="#notarget">禁用</a></td>'+
        '</tr>' +
        '</table>';
