...
function(e) {
    ...
    t.prototype.initLeftMenuCollapse = function() {
        var e = this;
        this.$leftMenuButton.on("click", 
        function(t) {
            t.preventDefault(),
            e.$body.toggleClass("fixed-left-void"),
    ...
    t.prototype.initMenu = function() {
        function t() {
            e(".has_sub").each(function() {
                var t = e(this);
                t.hasClass("nav-active") && t.find("> ul").slideUp(300, 
                function() {
        ...
        function() {
            var o = e(this).parent(),
            l = o.find("> ul");
            return i.$body.hasClass("sidebar-collapsed") || (l.is(":visible") ? l.slideUp(300, 
            function() {
            ...
            }) : (t(), o.addClass("nav-active"), o.find('.arrows').html('&#xe630;'), l.slideDown(300, 
            function() {
                n()
