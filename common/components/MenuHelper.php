...
class MenuHelper
{
     ...
     * @return array|mixed
     */
    public static function getAssignedMenu($roleName='数据统计', $root = null, $callback = null, $refresh = true)
    {
        ...
        $key = [__METHOD__, $roleName, $manager->defaultRoles];
        ...
        if ($refresh || $cache === null || ($assigned = $cache->get($key)) === false) {
            ...
            if ($roleName !== null) {
                $permissions  = $manager->getPermissionsByRole($roleName);
