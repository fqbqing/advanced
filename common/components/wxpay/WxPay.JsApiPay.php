...
class JsApiPay
{
	...
	public function GetOpenid()
	{
		...
		if (!isset($_GET['code'])){
			//触发微信返回code码
			//edit by wangzhaogang 20151217
			//因为已经在微信里设置oauth安全回调域名为wx.babamaiche.com 因此在mall项目中需要微信回跳地址时，需要由
			//http://wx.babamaiche.com/proxy.php?u=%s来跳转一次 这个proxy.php是之前专门为解决这个问题而做的方案
			$proxy = "http://wx.babamaiche.com/proxy.php?u=%s";
